...
extern void pin_release(int lpt);
extern int pin_have_irq(int lpt);
extern void pin_enable_irq(int lpt);
extern void pin_disable_irq(int lpt);

#else

/* userspace-only functions */
int pin_init_user(int lpt,int lp_base);
#define LPT1 0x378
#define LPT2 0x278
...
void set_pin(int lpt,int pins);
void clear_pin(int lpt,int pins);
void change_pin(int lpt, int pins, int state);
#define LP_CLEAR 0 /* for change_pin */
#define LP_SET   1 /* for change_pin */

int pin_is_set(int lpt,int pins);

void pin_input_mode(int lpt,int pins);
void pin_output_mode(int lpt,int pins);
void pin_mode(int lpt,int pins, int mode);
